...
class Response {
    ...
    private static function backCompatibility(){
        /**
         * Function for compatibility with PHP 5.3 (http_response_code  belongs to PHP >= 5.4 )
         */
        if (!function_exists('framework\http\http_response_code')) {
